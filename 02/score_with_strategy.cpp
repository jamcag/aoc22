...
int main() {
    const map<char, map<char, int>> scores{
        {'A', {{'X', SCISSORS_SCORE + LOSS_SCORE}, {'Y', ROCK_SCORE + DRAW_SCORE}, {'Z', PAPER_SCORE + WIN_SCORE}}},
        {'B', {{'X', ROCK_SCORE + LOSS_SCORE}, {'Y', PAPER_SCORE + DRAW_SCORE}, {'Z', SCISSORS_SCORE + WIN_SCORE}}},
        {'C', {{'X', PAPER_SCORE + LOSS_SCORE}, {'Y', SCISSORS_SCORE + DRAW_SCORE}, {'Z', ROCK_SCORE + WIN_SCORE}}},
    };
